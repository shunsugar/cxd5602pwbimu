...
{
  imu_topic_ = this->declare_parameter<std::string>("imu_topic", "/imu/spresense");
  odom_topic_ = this->declare_parameter<std::string>("odom_topic", "/odom");
  fused_odom_topic_ = this->declare_parameter<std::string>("fused_odom_topic", "/odom/wheel_spimu");
  ...
  RCLCPP_INFO(this->get_logger(), "Initialized wheel_spimu_odom_node.");
